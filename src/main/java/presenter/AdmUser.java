...
public class AdmUser {
    ...
    public static void editUser() {
        ...
        int atribute = JOptionPane.showOptionDialog(null, "Escolha o atributo a ser alterado:", "Altere o atributo",
    ...
    public static void editPokemon() {
        ...
        String[] options = { "id", "Nome", "Tipo", "Habilidades", "HP", "Ataque", "Defesa", "Ataque E.", "Defesa E.",
                "Velocidade" };
        int atribute = JOptionPane.showOptionDialog(null, "Escolha o atributo a ser alterado:", "Altere o atributo",
                JOptionPane.DEFAULT_OPTION, JOptionPane.INFORMATION_MESSAGE, null, options, options[0]);
        String value = JOptionPane.showInputDialog(null, "Digite o valor novo:");
